...
client.on('ready', () => {
  ...
  client.user.setGame(`!yardım | ${client.guilds.size} Sunucu | ${client.guilds.reduce((a, b) => a + b.memberCount, 0).toLocaleString()} Kişi`);
...
if (message.content.toLowerCase() === prefix + "i") {
       const embed = new Discord.RichEmbed()
           .addField("Bot Sahibi", `<@333368692962361345> `, true)
...
client.on("message", msg => {
if (msg.content.toLowerCase() === prefix + "gözlük-tak") {
  const embed = new Discord.RichEmbed()
  .setColor('RANDOM')
  .setTitle('')
  .setDescription('Gözlükleri takıyorum bebeğim')
  .setImage('https://n11scdn.akamaized.net/a1/450/giyim-ayakkabi/unisex-gunes-gozluk/deal-with-it-thug-life-tasarim-gunes-gozlugu-002__1365071729971644.jpg')
  msg.channel.send(embed);
}
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === prefix + 'davet') {
    ...
    .addField(msg.author.username, 'Özel mesajlarını kontrol et. :postbox:');
    msg.channel.sendEmbed(ozelmesajkontrol) }
      msg.author.sendMessage("Link: https://discordapp.com/oauth2/authorize?client_id=498442875223146499&scope=bot&permissions=2146958847 https://discordapp.com/oauth2/authorize?client_id=498442875223146499&scope=bot&permissions=2146958847").then(message => console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}] Gönderilen mesaj: ${message.content}`)).catch(console.error);
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === prefix + 'botu ekle') {
    ...
    .addField(msg.author.username, 'Özel mesajlarını kontrol et. :postbox:');
    msg.channel.sendEmbed(ozelmesajkontrol) }
      msg.author.sendMessage("Link: https://discordapp.com/oauth2/authorize?client_id=498442875223146499&scope=bot&permissions=2146958847").then(message => console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}] Gönderilen mesaj: ${message.content}`)).catch(console.error);
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === prefix + 'bilgi') {
    ...
    .addField(msg.author.username, 'Özel mesajlarını kontrol et. :postbox:');
    msg.channel.sendEmbed(ozelmesajkontrol) }
      msg.author.sendMessage('Bot sürümü: v' + ayarlar.surum + ' Yapımcı: Deniz ( Türkçe™ ) **FontRaw**\n\n_**BOTU EKLEMEK İÇİN LİNK:**_\n\nhttps://discordapp.com/oauth2/authorize?client_id=498442875223146499&scope=bot&permissions=2146958847 \n\n_**Linkler:**_\n\n**Sohbet ve Oyun** sunucusunun davet linki: https://discord.gg/jkARvng \nBotun davet linki: https://discordapp.com/oauth2/authorize?client_id=498442875223146499&scope=bot&permissions=2146958847 \n\n**:copyright: 2017 FontRaw **').then(message => console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}] Gönderilen mesaj: ${message.content}`)).catch(console.error);
  }
});
...
const girismesaj = [
  ...
  'Bot Serhan E. tarafından geliştirilmektedir (https://ploudosgame.com)',
  ...
  '',
  `**Sohbet ve Oyun BOT Resmî Discord Sunucusu** https://discord.gg/jkARvng`,
  `**BOT Davet Link** https://discordapp.com/oauth2/authorize?client_id=498442875223146499&scope=bot&permissions=2146958847`
]
